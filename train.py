...
# /home/zzj/.cache/huggingface/diffusers/models--runwayml--stable-diffusion-v1-5/snapshots/39593d5650112b4cc580433f6b0435385882d819
...
def parse_args():
    ...
    parser.add_argument(
        "--resolution",
        type=int,
        default=512,  # 768 for stabilityai/stable-diffusion-2, 512 for CompVis/stable-diffusion-v1-4
        help=(
